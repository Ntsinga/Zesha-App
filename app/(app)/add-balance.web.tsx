...
/**
 * Add Balance Web - Desktop optimized form for adding account balances
 */
    ...
    <div className="page-wrapper">
      ...
      <div className="dashboard-content">
        ...
        {missingAccounts.length > 0 && (
          <div className="missing-accounts-alert">
            <AlertTriangle className="missing-accounts-icon" size={20} />
            <div className="missing-accounts-content">
              <div className="missing-accounts-title">Missing Accounts</div>
              <div className="missing-accounts-list">
                {missingAccounts.map((acc) => acc.name).join(", ")}
              </div>
            </div>
          </div>
        )}
              ...
              return (
                ...
                >
                  ...
                  <div className="entry-card-body">
                      ...
                      {entry.validationResult && (
                        ...
                        >
                          {entry.validationResult.isValid ? (
                            <>
                              <Check size={14} /> Balance verified
                            </>
                          ) : (
                            <>
                    ...
                    {/* Image Upload */}
                    <div className="form-group">
                      <label className="form-label">Balance Screenshot</label>
                      <input
                        type="file"
                        accept="image/*"
                        ref={(el) => {
                      ...
                      {entryErrors.image && (
                        <span className="form-error">{entryErrors.image}</span>
                      )}
                    </div>
                  </div>
                </div>
